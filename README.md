...
**Ruby-Enumerables** is a ruby based methods that helps in using ruby enumerables with classes and modules.
...
This repository includes `myList.rb` and `myEnumerable.rb` files which are the class and modules files respectively.
